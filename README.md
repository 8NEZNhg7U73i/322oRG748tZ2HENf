...
> 提醒： Heroku 已经封禁本专案，请 Fork 本专案后，将 README.md 中的 8NEZNhg7U73i 替换为自己的用户名后，再进行部署。 
...
[Deploy](https://dashboard.heroku.com/new?template=https://github.com/8NEZNhg7U73i/322oRG748tZ2HENf) 

点击上面链接，会跳转到heroku app创建页面，填上应用的名称、选择节点(建议用欧洲节点，美国节点会自动删除YouTube评论与点赞！)、按需修改部分参数和UUID后点击下面`deploy`开始创建部署应用  
...
* **务必替换所有的`UUID`为部署时设置的UUID,建议更改,不要每个人都一样**  
...
* 插件选项: tls;host=xxx.herokuapp.com;path=/UUID-ss
```
</details>
